-- Migration 002: Compliance tables and seed data.
--
-- Creates:
...
--
-- Seeds 4 frameworks with 7 controls each:
...
-- W1: control_id intentionally has no FK to compliance_controls. Audit log entries
-- must survive control deletion for compliance trail preservation. Deleting a control
-- should NOT cascade-delete its historical status change records.
