 ...
 * `api/migrations/004_compliance.sql`. Idempotent via
...
const COMPLIANCE_SEED_SQL = `
  INSERT INTO compliance_frameworks (id, name, subtitle, compliance_percentage, controls_met, controls_total) VALUES
    ('seed-fw-soc2',     'SOC 2 Type II',  'Service Organization Control',   0, 0, 7),
    ('seed-fw-iso42001', 'ISO 42001',      'AI Management System',           0, 0, 7),
    ('seed-fw-euai',     'EU AI Act',      'European Union AI Regulation',   0, 0, 7),
    ('seed-fw-nist',     'NIST AI RMF',    'AI Risk Management Framework',   0, 0, 7)
  ON CONFLICT (id) DO NOTHING;
